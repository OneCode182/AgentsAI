# TEC-XXX | Dashboard Home: 

> Transitioning the main monitoring dashboard from simulated mock data to a production-ready real-time architecture.


---

## Objective
Establish data contracts and communication infrastructure (REST + WebSocket) to power the three main monitoring tables: Vehicles, People, and Parking Occupancy.
...
> [Placeholder for screenshot of Parking table]
...
| :--- | :--- | :--- |
| `GET` | `/api/v1/dashboard/{property_id}/home/summary/` | Initial state for home tab (Vehicles, People, Parking) |
| `GET` | `/api/v1/dashboard/{property_id}/home/vehicle/{id}/` | Lazy Load: Full vehicle authorization details |
| `GET` | `/api/v1/dashboard/{property_id}/home/person/{id}/` | Lazy Load: Full person authorization details |
| `GET` | `/api/v1/dashboard/{property_id}/home/parking/{id}/` | Lazy Load: Full parking spot details and authorized vehicles |
...
| Endpoint | Purpose |
| :--- | :--- |
| `/ws/dashboard/{property_id}/home/vehicles/` | Real-time stream for vehicle entries and exits |
| `/ws/dashboard/{property_id}/home/people/` | Real-time stream for authorized personnel and visitors |
| `/ws/dashboard/{property_id}/home/parking/` | Real-time stream for parking occupancy updates |
